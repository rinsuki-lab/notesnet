...
export type getNoteResponseError = (getNoteResponse400 | getNoteResponse401 | getNoteResponse403 | getNoteResponse404 | getNoteResponse500) & {
  headers: Headers;
};
...
export const getNote = async (noteId: string, options?: RequestInit): Promise<getNoteResponse> => {

  return customFetch<getNoteResponse>(getGetNoteUrl(noteId),
  {
    ...options,
    method: 'GET'
...
export const getGetNoteQueryOptions = <TData = Awaited<ReturnType<typeof getNote>>, TError = void>(noteId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getNote>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetNoteQueryKey(noteId);
   ...
   return  { queryKey, queryFn, enabled: !!(noteId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getNote>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
